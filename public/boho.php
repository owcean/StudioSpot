...
<body>
    ...
    <header>
        ...
        <div class="content-box">
            <h1 class="title">Boho Cozy Space</h1>
            <div class="image-gallery">
                <img src="img/boho 1.jpg" alt="Room Image 1">
                <img src="img/boho 2.jpg" alt="Room Image 2">
                <img src="img/boho 3.jpg" alt="Room Image 3">
                <img src="img/boho 4.jpg" alt="Room Image 4">
                <img src="img/boho 2.jpg" alt="Room Image 4" class="img-noshow">
            </div>
