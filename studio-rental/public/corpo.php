...
<body>
    ...
    <header>
        ...
        <div class="content-box">
            <h1 class="title">Corporate Studio </h1>
            <div class="image-gallery">
                <img src="img/corpo 1.jpg" alt="Room Image 1">
                <img src="img/corpo 2.jpg" alt="Room Image 2">
                <img src="img/corpo 3.jpg" alt="Room Image 3">
                <img src="img/corpo 5.jpg" alt="Room Image 4">
                <img src="img/corpo 2.jpg" alt="Room Image 4" class="img-noshow">
            </div>
